...
1. It is not recommended to build in the GPU before reaching [Step 5](https://github.com/techbygiusi/Guides/blob/main/Proxmox%20AMD%20GPU%20Passthrough/README.md#step-5-adding-gpu-to-vfio) on an MS-01. If the iGPU is deactivated, only display output through the GPU will work. 😅
